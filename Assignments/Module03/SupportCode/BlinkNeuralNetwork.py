...
class BlinkNeuralNetwork(torch.nn.Module):
    def __init__(self, hiddenNodes = 10, hiddenNodes2 = 2):
    ...
    def forward(self, x):
        ...
        # out = self.convulationLayer1(out)
        out = self.fullyConnectedOne(out)
        # out = self.convulationLayer2(out)
