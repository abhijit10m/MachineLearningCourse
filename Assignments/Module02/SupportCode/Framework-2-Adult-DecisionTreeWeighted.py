kOutputDirectory = "/Users/bhatnaa/Documents/uw/csep546/module1/MachineLearningCourse/MachineLearningCourse/visualize/Module2/Assignment2/UseWeightedDecisionTrees"
...
def compareWithVsWithoutNumericFeatures(bestModelWithNumericFeatures, bestModelWithoutNumericFeatures):
    ...
    Charting.PlotROCs(seriesFPRs, seriesFNRs, seriesLabels, useLines=True, chartTitle="ROC", xAxisTitle="False Negative Rate", yAxisTitle="False Positive Rate", outputDirectory=kOutputDirectory, fileName="Plot-Adult-DecisionTreeWeighted-WithVsWithoutNumericalFeatures")
